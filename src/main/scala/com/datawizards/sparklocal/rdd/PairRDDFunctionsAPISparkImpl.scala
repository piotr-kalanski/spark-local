  ...
  extends PairRDDFunctionsAPI[K,V]
{
  ...
  override def join[W: ClassTag: TypeTag](other: RDDAPI[(K, W)]): RDDAPI[(K, (V, W))] =
    RDDAPI(data.join(other.toRDD))

  override def join[W: ClassTag: TypeTag](other: RDDAPI[(K, W)], numPartitions: Int): RDDAPI[(K, (V, W))] =
    RDDAPI(data.join(other.toRDD, numPartitions))

  override def join[W: ClassTag: TypeTag](other: RDDAPI[(K, W)], partitioner: Partitioner): RDDAPI[(K, (V, W))] =
    RDDAPI(data.join(other.toRDD, partitioner))

  override def leftOuterJoin[W: ClassTag: TypeTag](other: RDDAPI[(K, W)]): RDDAPI[(K, (V, Option[W]))] =
    RDDAPI(data.leftOuterJoin(other.toRDD))

  override def leftOuterJoin[W: ClassTag: TypeTag](other: RDDAPI[(K, W)], numPartitions: Int): RDDAPI[(K, (V, Option[W]))] =
    RDDAPI(data.leftOuterJoin(other.toRDD, numPartitions))

  override def leftOuterJoin[W: ClassTag: TypeTag](other: RDDAPI[(K, W)], partitioner: Partitioner): RDDAPI[(K, (V, Option[W]))] =
    RDDAPI(data.leftOuterJoin(other.toRDD, partitioner))

  override def rightOuterJoin[W: ClassTag: TypeTag](other: RDDAPI[(K, W)]): RDDAPI[(K, (Option[V], W))] =
    RDDAPI(data.rightOuterJoin(other.toRDD))

  override def rightOuterJoin[W: ClassTag: TypeTag](other: RDDAPI[(K, W)], numPartitions: Int): RDDAPI[(K, (Option[V], W))] =
    RDDAPI(data.rightOuterJoin(other.toRDD, numPartitions))

  override def rightOuterJoin[W: ClassTag: TypeTag](other: RDDAPI[(K, W)], partitioner: Partitioner): RDDAPI[(K, (Option[V], W))] =
    RDDAPI(data.rightOuterJoin(other.toRDD, partitioner))

  override def fullOuterJoin[W: ClassTag: TypeTag](other: RDDAPI[(K, W)]): RDDAPI[(K, (Option[V], Option[W]))] =
    RDDAPI(data.fullOuterJoin(other.toRDD))

  override def fullOuterJoin[W: ClassTag: TypeTag](other: RDDAPI[(K, W)], numPartitions: Int): RDDAPI[(K, (Option[V], Option[W]))] =
    RDDAPI(data.fullOuterJoin(other.toRDD, numPartitions))

  override def fullOuterJoin[W: ClassTag: TypeTag](other: RDDAPI[(K, W)], partitioner: Partitioner): RDDAPI[(K, (Option[V], Option[W]))] =
  ...
  override def cogroup[W1: ClassTag: TypeTag, W2: ClassTag: TypeTag, W3: ClassTag: TypeTag](other1: RDDAPI[(K, W1)], other2: RDDAPI[(K, W2)], other3: RDDAPI[(K, W3)]): RDDAPI[(K, (Iterable[V], Iterable[W1], Iterable[W2], Iterable[W3]))] =
    RDDAPI(data.cogroup(other1.toRDD, other2.toRDD, other3.toRDD))

  override def cogroup[W: ClassTag: TypeTag](other: RDDAPI[(K, W)]): RDDAPI[(K, (Iterable[V], Iterable[W]))] =
    RDDAPI(data.cogroup(other.toRDD))

  override def cogroup[W1: ClassTag: TypeTag, W2: ClassTag: TypeTag](other1: RDDAPI[(K, W1)], other2: RDDAPI[(K, W2)]): RDDAPI[(K, (Iterable[V], Iterable[W1], Iterable[W2]))] =
  ...
  override def subtractByKey[W: ClassTag: TypeTag](other: RDDAPI[(K, W)]): RDDAPI[(K, V)] =
    RDDAPI(data.subtractByKey(other.toRDD))

  override def subtractByKey[W: ClassTag: TypeTag](other: RDDAPI[(K, W)], numPartitions: Int): RDDAPI[(K, V)] =
    RDDAPI(data.subtractByKey(other.toRDD, numPartitions))

  override def subtractByKey[W: ClassTag: TypeTag](other: RDDAPI[(K, W)], p: Partitioner): RDDAPI[(K, V)] =
